...
ap.add_argument('-p', '--prototxt', default='D:/object detection/MobileNetSSD_deploy.prototxt.txt', help='path to Caffe deploy prototxt file')
ap.add_argument('-m', '--model', default='D:/object detection/MobileNetSSD_deploy.caffemodel', help='path to the Caffe pre-trained model')
